                            ...
                            <div class="col-md-3 col-sm-3">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="profile_wrap">
                                        <h5 class="uppercase underline">Testimoniku</h5>
                                        <div class="my_vehicles_list">
                                            <ul class="vehicle_listing">
                                                <?php
                                                $emailPenyewa = $_SESSION['login'];
                                                $sql = "SELECT * from testimoni where emailPenyewa=:emailPenyewa";
                                                $query = $dbh->prepare($sql);
                                                $query->bindParam(':emailPenyewa', $emailPenyewa, PDO::PARAM_STR);
                                                $query->execute();
                                                $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                    ...
                                                    foreach ($results as $result) { ?>
                                                        <li>
                                                            <div>
                                                                ...
                                                                <p><b>Posting Date:</b><?php echo htmlentities($result->tglTestimoni); ?> </p>
                                                            </div>
                                                            <?php if ($result->status == 1) { ?>
                                                                <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Terbit</a>
