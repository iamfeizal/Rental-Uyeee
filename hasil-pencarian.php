...
<head>
    ...
    <title>Rental UYEEE | Hasil Pencarian Motor</title>
    <!--Bootstrap -->
                ...
                <div class="col-md-9 col-md-push-3">
                    <div class="result-sorting-wrapper">
                        <div class="sorting-count">
                            ...
                            $sql = "SELECT idMotor FROM motor WHERE motor.idMerk=:merk AND motor.bahanBakar=:bahanBakar";
                            ...
                            $cnt = $query->rowCount();
                            ?>
                            <p><span><?php echo htmlentities($cnt); ?> Hasil</span></p>
                        </div>
                    </div>

                    <?php
                    $sql1 = "SELECT motor.*,merk.namaMerk,merk.idMerk AS bid FROM motor JOIN merk ON merk.idMerk=motor.idMerk WHERE motor.idMerk=:merk AND motor.bahanBakar=:bahanBakar";
                        ...
                        foreach ($results as $result) {  ?>
                            <div class="product-listing-m gray-bg">
                                ...
                                <div class="product-listing-content">
                                    ...
                                    <a href="detail-motor.php?mtid=<?php echo htmlentities($result->idMotor); ?>" class="btn">Detail Motor <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                                </div>
                            </div>
                    <?php }
                    } ?>
