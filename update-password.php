...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "SELECT password FROM penyewa WHERE emailPenyewa=:emailPenyewa and password=:password";
        ...
        if ($query->rowCount() > 0) {
            $con = "UPDATE penyewa SET password=:newpassword WHERE emailPenyewa=:emailPenyewa";
...
?>
    ...
    <head>
        ...
        <title>Rental UYEEE | Ubah Password</title>
        <!--Bootstrap -->
        ...
        <script type="text/javascript">
            function valid() {
                if (document.chngpwd.newpassword.value != document.chngpwd.confirmpassword.value) {
                    alert("Password Baru and Konfirmasi Password Baru Tidak Sama  !!");
                                ...
                                <div class="col-md-6 col-sm-8">
                                    <div class="profile_wrap">
                                        <form name="chngpwd" method="post" onSubmit="return valid();">
                                            ...
                                            <div class="form-group">
                                                <input type="submit" value="Simpan" name="update" id="submit" class="btn btn-block">
                                            </div>
                                        </form>
                                    </div>
                                </div>
