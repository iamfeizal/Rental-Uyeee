...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "SELECT password FROM admin WHERE emailAdmin=:emailAdmin and password=:password";
		...
		if ($query->rowCount() > 0) {
			$con = "UPDATE admin SET password=:newpassword where emailAdmin=:emailAdmin";
			$chngpwd1 = $dbh->prepare($con);
			$chngpwd1->bindParam(':emailAdmin', $emailAdmin, PDO::PARAM_STR);
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Password Ubah</h2>
